...
app.get('/api/sitemap.xml', async (req, res) => {
  ...
  const CITIES = [
    ...
    { slug: 'bangalore',    name: 'Bangalore',     region: 'Karnataka' },
    { slug: 'hyderabad',    name: 'Hyderabad',     region: 'Telangana' },
    { slug: 'chennai',      name: 'Chennai',       region: 'Tamil Nadu' },
    { slug: 'kolkata',      name: 'Kolkata',       region: 'West Bengal' },
    { slug: 'pune',         name: 'Pune',          region: 'Maharashtra' },
    ...
    { slug: 'navi-mumbai',  name: 'Navi Mumbai',    region: 'Maharashtra' },
    { slug: 'thane',        name: 'Thane',          region: 'Maharashtra' },
    { slug: 'ahmedabad',    name: 'Ahmedabad',     region: 'Gujarat' },
    { slug: 'chandigarh',   name: 'Chandigarh',     region: 'Chandigarh' },
    { slug: 'lucknow',      name: 'Lucknow',       region: 'Uttar Pradesh' },
    { slug: 'kochi',        name: 'Kochi',          region: 'Kerala' },
    { slug: 'indore',       name: 'Indore',         region: 'Madhya Pradesh' },
    { slug: 'bhopal',       name: 'Bhopal',         region: 'Madhya Pradesh' },
    { slug: 'surat',        name: 'Surat',          region: 'Gujarat' },
    { slug: 'vadodara',     name: 'Vadodara',       region: 'Gujarat' },
    { slug: 'rajkot',       name: 'Rajkot',         region: 'Gujarat' },
    { slug: 'nagpur',       name: 'Nagpur',         region: 'Maharashtra' },
    { slug: 'coimbatore',   name: 'Coimbatore',     region: 'Tamil Nadu' },
    { slug: 'visakhapatnam',name: 'Visakhapatnam',   region: 'Andhra Pradesh' },
    { slug: 'mangalore',    name: 'Mangalore',      region: 'Karnataka' },
    { slug: 'mysore',       name: 'Mysore',         region: 'Karnataka' },
    { slug: 'dehradun',     name: 'Dehradun',       region: 'Uttarakhand' },
    { slug: 'patna',        name: 'Patna',          region: 'Bihar' },
    { slug: 'bhubaneswar',  name: 'Bhubaneswar',    region: 'Odisha' },
    { slug: 'raipur',       name: 'Raipur',         region: 'Chhattisgarh' },
    { slug: 'ranchi',       name: 'Ranchi',         region: 'Jharkhand' },
    { slug: 'jamshedpur',   name: 'Jamshedpur',     region: 'Jharkhand' },
    { slug: 'guwahati',     name: 'Guwahati',       region: 'Assam' },
    { slug: 'ludhiana',     name: 'Ludhiana',       region: 'Punjab' },
    { slug: 'jalandhar',    name: 'Jalandhar',      region: 'Punjab' },
    { slug: 'kanpur',       name: 'Kanpur',         region: 'Uttar Pradesh' },
    { slug: 'allahabad',    name: 'Prayagraj',      region: 'Uttar Pradesh' },
    { slug: 'varanasi',     name: 'Varanasi',       region: 'Uttar Pradesh' },
    { slug: 'srinagar',     name: 'Srinagar',       region: 'Jammu & Kashmir' },
    { slug: 'jammu',        name: 'Jammu',          region: 'Jammu & Kashmir' },
    { slug: 'shimla',       name: 'Shimla',         region: 'Himachal Pradesh' },
    { slug: 'goa',          name: 'Goa',           region: 'Goa' },
    { slug: 'trivandrum',   name: 'Thiruvananthapuram', region: 'Kerala' },
    { slug: 'madurai',      name: 'Madurai',        region: 'Tamil Nadu' },
    { slug: 'gwalior',      name: 'Gwalior',        region: 'Madhya Pradesh' },
    { slug: 'jabalpur',     name: 'Jabalpur',       region: 'Madhya Pradesh' },
    { slug: 'bilaspur',     name: 'Bilaspur',       region: 'Chhattisgarh' },
    { slug: 'siliguri',     name: 'Siliguri',       region: 'West Bengal' },
    { slug: 'aligarh',      name: 'Aligarh',        region: 'Uttar Pradesh' },
    { slug: 'bareilly',     name: 'Bareilly',       region: 'Uttar Pradesh' },
    { slug: 'moradabad',    name: 'Moradabad',      region: 'Uttar Pradesh' },
    { slug: 'mathura',      name: 'Mathura',        region: 'Uttar Pradesh' },
    { slug: 'kolhapur',     name: 'Kolhapur',       region: 'Maharashtra' },
    { slug: 'nashik',       name: 'Nashik',         region: 'Maharashtra' },
    { slug: 'aurangabad',   name: 'Aurangabad',     region: 'Maharashtra' },
    { slug: 'saharanpur',   name: 'Saharanpur',     region: 'Uttar Pradesh' },
  ];
